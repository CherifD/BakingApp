...
public class RecipeToRecipeStepNavigationTabletTest {
    @Rule
    ...
    public void testRecipesRecyclerViewDisplay() {
        onView(withId(R.id.rclv_recipes_tablet)).check(matches(isDisplayed()));
    }
    ...
    public void testRecipeToRecipeStepNativation() {
        ...
        for (int i = 0; i < resipeTitles.length; i++) {
            ...
            onView(withId(R.id.rclv_recipes_tablet))
